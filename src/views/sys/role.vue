  ...
  <div class="app-page mod-role">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList(true)">
      ...
      <el-form-item>
        ...
        <el-button v-permisson="permisson.roleDelete" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除
        </el-button>
      </el-form-item>
    </el-form>
    ...
    <!-- 弹窗, 新增 / 修改 -->
    <add-or-update ref="addOrUpdate" :menu-list="menuList" @close="addOrUpdateVisible = false" @refreshDataList="getDataList"

<template>
  <div class="app-page isedit mod-base">
    <el-form ref="dataForm" :model="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="108px">
      <el-form-item label="新郎姓名" required>
        <el-input v-model="dataForm.groomName" placeholder="新郎姓名"></el-input>
      </el-form-item>
      <el-form-item label="新娘姓名" required>
        <el-input v-model="dataForm.brideName" placeholder="新娘姓名"></el-input>
      </el-form-item>
      <el-form-item label="婚礼日期" required>
      ...
      <el-form-item label="农历" required>
      ...
      <el-form-item label="背景音乐" required>
      ...
      <el-form-item label="分享名称" required>
        <el-input v-model="dataForm.share" placeholder="分享名称"></el-input>
      </el-form-item>
      <el-form-item label="分享缩略图" required>
